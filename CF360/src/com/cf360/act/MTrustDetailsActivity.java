...
//				"发行机构", "佣金比例", "预期收益");
	...
	private void initData() {
		...
		mTextArray.add("排序");
		mTextArray.add("筛选");
		myBaseAdapter = new MyBaseAdapter(resultListViewItem,
				MTrustDetailsActivity.this);
			...
			public void onRefresh(PullToRefreshBase<ListView> refreshView) {
				...
				if (refreshView.isHeaderShown()) {
					if (filterType.equals("0")) {
						...
						if (infoPage >= 2) {
							requestSaiXuanData("信托", "defaultType", "1",
									(--infoPage), annualRate, commission,
									investmentField, issuer);
						} else {
							requestSaiXuanData("信托", "defaultType", "1", 1,
	...
	private void initTopTitle() {
		...
		title.setCenterText(
				getResources().getString(R.string.xintuo_Details_title))
				...
				.setOnActionListener(new OnActionListener() {
					...
					public void onAction(int id) {
						...
						case 2:
							...
							Search.setClass(MTrustDetailsActivity.this,
	...
	class MyItemClickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			String creditLevel = resultListViewItem.get(position - 1)
					.getCreditLevel();
			Intent intent = new Intent(MTrustDetailsActivity.this,
		...
		public View getView(final int position, View convertView,
			...
			if (convertView == null) {
				...
				convertView = LayoutInflater.from(this.mContext).inflate(
						R.layout.m_item_xintuoadapter, null, false);
				holder.Title_content_text = (TextView) convertView
						.findViewById(R.id.xintuo_title_content);
				holder.Type_Hot_text = (TextView) convertView
						.findViewById(R.id.xintuo_type_Hot_text);
				holder.ATypeImage = (ImageView) convertView
						.findViewById(R.id.xintuo_type_image);
				holder.Type_Branch_text = (TextView) convertView
						.findViewById(R.id.xintuo_type_Branch_text);
				holder.Type_Include_text = (TextView) convertView
						.findViewById(R.id.xintuo_type_Include_text);
				holder.Type_Include_image = (RelativeLayout) convertView
						.findViewById(R.id.xintuo_type_Include_image);
				holder.Type_Hot_image = (RelativeLayout) convertView
						.findViewById(R.id.xintuo_type_Hot_image);
				holder.Type_Branch_image = (RelativeLayout) convertView
						.findViewById(R.id.xintuo_type_Branch_image);
				holder.Content_Money = (TextView) convertView
						.findViewById(R.id.xintuo_content_first_one);
				holder.Content_Month = (TextView) convertView
						.findViewById(R.id.xintuo_content_Second_one);
				holder.TypeTuijianImage = (RelativeLayout) convertView
						.findViewById(R.id.xintuo_type_tuijian_image);

				holder.Content_Proportion = (TextView) convertView
						.findViewById(R.id.xintuo_content_Third_one);
				holder.mProgressBar = (MyProgressBar) convertView
						.findViewById(R.id.xintuo_ProgressBar);
	...
	private void requestData(String category, String defaultType,
		...
		HtmlRequest.xinItemResult(MTrustDetailsActivity.this, category,
				defaultType, filterType, pageNo, new OnRequestListener() {
					private ResultXinTuoItemContentBean data;
	...
	private void requestSaiXuanData(String category, String defaultType,
		...
		HtmlRequest.xinSaiItemResult(MTrustDetailsActivity.this, category,
	...
	private void initListener() {
		...
		viewRight.setOnSelectListener(new ViewRight.OnSelectListener() {
			...
			public void getConfirm() {
				...
				filterType = "1";
				infoPage = 1;
				requestSaiXuanData("信托", "defaultType", filterType, infoPage,
