...
//		requestSearchProduct("信托","1");
    ...
    private void requestSearchProduct(String productName, String pageNo) {
        ...
        HtmlRequest.getSearchProduct(SearchProductActivity.this, productName, pageNo, new OnRequestListener() {
            @Override
            public void onRequestFinished(BaseParams params) {
                ...
                if (bean != null) {
                    ...
                    if (bean.getProductList().size() == 0 && searchProductPage != 1) {
                        Toast.makeText(SearchProductActivity.this, "已经到最后一页", Toast.LENGTH_SHORT).show();
                        searchProductPage--;
...
//							System.out.println(bean.getProductName());
                    ...
                    Toast.makeText(SearchProductActivity.this, "加载失败，请确认网络通畅", Toast.LENGTH_LONG).show();
                }
    ...
    private void initTopTitle() {
        ...
        title.setTitle(getResources().getString(R.string.title_no)).setCenterText(getResources().getString(R.string.title_search_product)).setLogo(R.drawable.img_logo, false).setIndicator(R.drawable.back).showMore(false).setOnActionListener(new OnActionListener() {
