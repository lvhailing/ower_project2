...
import com.cf360.view.FixedSpeedScroller;
...
public class CycleAdapter extends ViewPager {
    ...
    /**
     * @param context 构造函数
     * @param images  添加轮播图对应的布局
     */
    public CycleAdapter(Context context, ArrayList<ImageBean> images, DisplayImageOptions options) {
        super(context);
    ...
    private void getNetImage() {
        int ids[] = {R.drawable.cf360_hot, R.drawable.cf360_hot, R.drawable.cf360_hot, R.drawable.cf360_hot};
...
//			currentItem = 250;
    ...
    /**
     * @yangzheng MyPagerAdapter 适配器，负责装配 、销毁 数据 和 组件
     */
