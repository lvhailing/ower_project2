...
public class NoticeListAdapter extends BaseAdapter {
	...
	private MouldList<NoticeListDataContentBean> list = new MouldList<NoticeListDataContentBean>();
	private LayoutInflater inflater;
	public NoticeListAdapter(Context context,MouldList<NoticeListDataContentBean> messageList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tv_notice_item_title.setText(list.get(position).getTOPIC());
...
//		}
		...
		holder.tv_notice_item_context.setText(list.get(position).getDESCRIPTION());
