...
public class RecommendProductBxAdapter extends BaseAdapter {
	...
	public RecommendProductBxAdapter(Context context,
...
//		Log.e(tag, "getView=="+list.get(position).getAMOUNT());
		...
		holder.tv_prodeuct_recommend_content_first_two.setText("保险公司");
		holder.tv_prodeuct_recommend_content_Second_two.setText("保险期间");
		holder.tv_product_recommend_content_Third_two.setText("返佣比例");
		holder.tv_prodeuct_recommend_content_first_one.setText(list.get(position).getCOMPANYNAME());
