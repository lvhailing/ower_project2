...
public class RecommendProductYgsmAdapter extends BaseAdapter {

	private MouldList<ResultRecommendProductContentBean> list;
	private Context context;
	private LayoutInflater inflater;
	private ImageLoader imageLoader = ImageLoader.getInstance();
	public RecommendProductYgsmAdapter(Context context,
...
//		holder.mypb_recommendproduct_ProgressBar.setVisibility(View.GONE);
		...
		holder.tv_prodeuct_recommend_content_Second_two.setText("累计净值");
