...
public class ResultEquityDetialsItem implements IMouldType{
	...
	public void setIfMax(String ifMax) {
		this.ifMax = ifMax;
	}
	public String getIfMin() {
		return ifMin;
	}
	public void setIfMin(String ifMin) {
		this.ifMin = ifMin;
	}
