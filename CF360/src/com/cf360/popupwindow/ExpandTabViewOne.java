...
public class ExpandTabViewOne extends LinearLayout implements OnDismissListener {
	...
	public ExpandTabViewOne(Context context) {
		super(context);
		init(context);
	}

	public ExpandTabViewOne(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	public void setValue(ArrayList<String> textArray, ArrayList<View> viewArray) {
		...
		for (int i = 0; i < viewArray.size(); i++) {
			...
			mViewArray.add(r);
			r.setTag(SMALL);
			ToggleButton tButton = (ToggleButton) inflater.inflate(R.layout.toggle_button_one, this, false);
			addView(tButton);
