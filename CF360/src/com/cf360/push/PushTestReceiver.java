...
import com.cf360.act.SplashActivity;
...
//		Toast.makeText(context, responseString, 0).show();
//		Toast.makeText(context, responseString, 0).show();
		String STORE_NAME = "PushTestReceiver";    
		SharedPreferences sharedPreferences = context.getSharedPreferences(STORE_NAME,MODE_PRIVATE);
