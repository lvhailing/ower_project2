...
public class PreferenceUtil {
    ...
    public static void setUserType(String type) {
        getUserSharedPreferences().edit().putString("userType", type).commit();
    }
    ...
    public static String getUserType() {
        return getUserSharedPreferences().getString("userType", "");
    }
     ...
     * @return
     */
    public static String isAuditStatus() {
        return getUserSharedPreferences().getString("auditStatusMsg", "");
    }
     ...
     * @param status
     */
    public static void setAuditStatus(String status) {
        getUserSharedPreferences().edit().putString("auditStatusMsg", status).commit();
    }
