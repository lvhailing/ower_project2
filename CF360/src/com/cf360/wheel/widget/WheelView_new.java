 ...
 */
public class WheelView_new extends View {
	 ...
	 * Constructor
	 */
	public WheelView_new(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public WheelView_new(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public WheelView_new(Context context) {
		super(context);
		initData(context);
	}
