package com.cf360.widget.entity;
...
public class GesturePoint {
	...
	public void setPointState(int state) {
		...
		case ApplicationConsts.POINT_STATE_NORMAL:
			this.image.setBackgroundResource(R.drawable.gesture_node_normal_2);
			break;
		case ApplicationConsts.POINT_STATE_SELECTED:
			this.image.setBackgroundResource(R.drawable.gesture_node_pressed_2);
			break;
		case ApplicationConsts.POINT_STATE_WRONG:
			this.image.setBackgroundResource(R.drawable.gesture_node_wrong_2);
			break;
		default:
			break;
		}
